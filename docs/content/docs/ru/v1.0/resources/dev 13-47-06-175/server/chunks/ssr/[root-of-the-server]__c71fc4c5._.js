...
"[project]/src/utils/axios.server.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const customRequest = async ({ method = "get", url, headers = {}, data = {}, withCredentials = true, baseURL = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$site$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ENDPOINTS"].http_server_base })=>{
    ...
    const next_response = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NextResponse"].json(response.data, {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axios$2e$server$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/axios.server.ts [app-ssr] (ecmascript)"); // server-side fetch
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$site$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/site.ts [app-ssr] (ecmascript)");
;
;
;
...
async function UserProvider({ children }) {
    let user = null;
    try {
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axios$2e$server$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getRequest"])({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c71fc4c5._.js.map