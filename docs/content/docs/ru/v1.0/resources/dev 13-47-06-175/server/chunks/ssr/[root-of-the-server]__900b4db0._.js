...
"[project]/src/app/api/proxy/route.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handleRequest(req, options) {
    const { method = "get", url, data, headers = {}, setNewCookie } = options;
    const cookieStore = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cookies"])();
    const allCookies = cookieStore.getAll();
    const cookieHeader = allCookies.map((c)=>`${c.name}=${c.value}`).join("; ");
    const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])({
        method,
        ...
        baseURL: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$site$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ENDPOINTS"].http_server_base
    });
    const next_res = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["NextResponse"].json(response.data, {
        status: response.status
    });
    const setCookies = response.headers["set-cookie"];
    if (setCookies) {
        if (Array.isArray(setCookies)) {
            setCookies.forEach((c)=>next_res.headers.append("Set-Cookie", c));
        } else {
            next_res.headers.append("Set-Cookie", setCookies);
        }
    }
    if (setNewCookie) {
        next_res.cookies.set({
            name: setNewCookie.name,
            value: setNewCookie.value,
            ...setNewCookie.options
        });
    }
    return next_res;
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$proxy$2f$route$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/api/proxy/route.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$site$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/site.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/axios/lib/axios.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/headers.js [app-rsc] (ecmascript)");
;
...
const getRequest = async (params)=>await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$proxy$2f$route$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["handleRequest"])(params);
const postRequest = async (params)=>await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$proxy$2f$route$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["handleRequest"])({
        ...params,
        method: "post"
    });
const putRequest = async (params)=>await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$proxy$2f$route$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["handleRequest"])({
        ...params,
        method: "put"
    });
const patchRequest = async (params)=>await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$proxy$2f$route$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["handleRequest"])({
        ...params,
        method: "patch"
    });
const deleteRequest = async (params)=>await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$proxy$2f$route$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["handleRequest"])({
        ...params,
        method: "delete"
    });
...
async function getData() {
    const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axios$2e$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getRequest"])({
...
//   `${ENDPOINTS.http_server_base}${ENDPOINTS.transaction_list}`,
//   {
//     method: "GET",
//     headers: {
...
async function User() {
    ...
    //   try {
    //     const { data } = await getRequest({ url: ENDPOINTS.transaction_list });
    //   } catch {}
    // };
    // useEffect(() => {
    //   get_data();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__900b4db0._.js.map