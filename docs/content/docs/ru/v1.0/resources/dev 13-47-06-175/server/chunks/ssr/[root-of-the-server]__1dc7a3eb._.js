...
axiosInstance.interceptors.response.use((response)=>response, async (error)=>{
    ...
    if (code === "expired_token" && error.response.status === 401) {
        if (!isRefreshing) {
            isRefreshing = true;
            try {
                const _ = await axios.post(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$site$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ENDPOINTS"].http_client_base}${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$site$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ENDPOINTS"].refresh_token}`);
...
function SignIn() {
    ...
    const handleSubmit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (event)=>{
        ...
        try {
            ...
            const { data, status } = getError(err);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1dc7a3eb._.js.map