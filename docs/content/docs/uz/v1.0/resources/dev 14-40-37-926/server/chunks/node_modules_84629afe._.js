...
*/ const localeResolver = (selectedLocale, locales = __TURBOPACK__imported__module__$5b$project$5d2f2e$intlayer$2f$config$2f$configuration$2e$json__$28$json$29$__["default"]?.internationalization?.locales, defaultLocale = __TURBOPACK__imported__module__$5b$project$5d2f2e$intlayer$2f$config$2f$configuration$2e$json__$28$json$29$__["default"]?.internationalization?.defaultLocale)=>{
...
*/ const getLocaleFromStorage = (options)=>{
    const { routing, internationalization } = __TURBOPACK__imported__module__$5b$project$5d2f2e$intlayer$2f$config$2f$configuration$2e$json__$28$json$29$__["default"];
...
*/ const setLocaleInStorage = (locale, options)=>{
    if (__TURBOPACK__imported__module__$5b$project$5d2f2e$intlayer$2f$config$2f$configuration$2e$json__$28$json$29$__["default"].routing.storage === false || options?.isCookieEnabled === false) return;
    const storageAttributes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$core$2f$dist$2f$esm$2f$getStorageAttributes$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["getStorageAttributes"])(__TURBOPACK__imported__module__$5b$project$5d2f2e$intlayer$2f$config$2f$configuration$2e$json__$28$json$29$__["default"].routing.storage);
    for(let i = 0; i < storageAttributes.cookies.length; i++){
...
const { internationalization, routing } = __TURBOPACK__imported__module__$5b$project$5d2f2e$intlayer$2f$config$2f$configuration$2e$json__$28$json$29$__["default"] ?? {};
...
*/ const getLocaleFromPath = (inputUrl)=>{
    const { defaultLocale, locales } = __TURBOPACK__imported__module__$5b$project$5d2f2e$intlayer$2f$config$2f$configuration$2e$json__$28$json$29$__["default"]?.internationalization ?? {};
...
*/ const getPathWithoutLocale = (inputUrl, locales = __TURBOPACK__imported__module__$5b$project$5d2f2e$intlayer$2f$config$2f$configuration$2e$json__$28$json$29$__["default"]?.internationalization?.locales)=>{
    const isAbsoluteUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$core$2f$dist$2f$esm$2f$utils$2f$checkIsURLAbsolute$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["checkIsURLAbsolute"])(inputUrl);
    let fixedInputUrl = inputUrl;
    if (inputUrl.endsWith("/")) fixedInputUrl = inputUrl.slice(0, -1);
...
//# sourceMappingURL=node_modules_84629afe._.js.map