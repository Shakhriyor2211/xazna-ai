...
"[project]/node_modules/@intlayer/config/dist/esm/logger.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const colorizeLocales = (locales, color = ANSIColors.GREEN, reset = ANSIColors.RESET)=>[
        locales
    ].flat().map((locale)=>colorize(locale, color, reset)).join(`, `);
const colorizeKey = (keyPath, color = ANSIColors.BEIGE, reset = ANSIColors.RESET)=>[
        keyPath
    ].flat().map((key)=>colorize(key, color, reset)).join(`, `);
const colorizePath = (path, color = ANSIColors.GREY, reset = ANSIColors.RESET)=>[
        path
    ].flat().map((p)=>colorize(p, color, reset)).join(`, `);
/**
...
"[project]/node_modules/@intlayer/config/dist/esm/utils/cacheMemory.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
/** ------------------------- Utilities ------------------------- **/ /** Prefer a fast non-crypto hash if available, then fast crypto, then sha256. */ const pickHashAlgorithm = ()=>{
    try {
        (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["createHash"])("xxhash64").update("test").digest();
        return "xxhash64";
    } catch  {}
    try {
        (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["createHash"])("sha1").update("test").digest();
        return "sha1";
    } catch  {}
    return "sha256";
};
const HASH_ALGORITHM = pickHashAlgorithm();
/** Base64url without padding for compact, file-system-safe ids. */ const toBase64Url = (buffer)=>buffer.toString("base64").replace(/\+/g, "-").replace(/\//g, "_").replace(/=+$/g, "");
/** Token helpers to minimize collisions while streaming to the hasher. */ const token = {
...
*/ const stableHashValue = (hasher, value, seen)=>{
    ...
    if (value instanceof Map) {
        ...
        seen.add(mapObject);
        const entries = [];
        for (const [k, v] of mapObject.entries())entries.push([
            stableStringify(k),
            v
        ]);
...
/** Public stringify kept for convenience / debugging (now faster & broader). */ const stableStringify = (value, _stack = /* @__PURE__ */ new WeakSet())=>{
    const hasher = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["createHash"])(HASH_ALGORITHM);
    stableHashValue(hasher, value, _stack);
    return toBase64Url(hasher.digest());
};
/** Compute a compact, stable id for arbitrary key tuples. */ const computeKeyId = (keyParts)=>{
    const h = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["createHash"])(HASH_ALGORITHM);
    token.start(h, "keys");
...
"[project]/node_modules/@intlayer/config/dist/esm/utils/getPackageJsonPath.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$cacheMemory$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/utils/cacheMemory.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:path [external] (node:path, cjs)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:fs [external] (node:fs, cjs)");
const __TURBOPACK__import$2e$meta__ = {
    get url () {
        return `file://${__turbopack_context__.P("node_modules/@intlayer/config/dist/esm/utils/getPackageJsonPath.mjs")}`;
    }
};
;
;
...
const isESModule = typeof __TURBOPACK__import$2e$meta__.url === "string";
const MAX_LEVELS = 15;
const getPackageJsonPath = (startDir = process.cwd())=>{
    const checkedCache = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$cacheMemory$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["cacheMemory"].get("packageJsonPath", startDir);
    if (checkedCache) return checkedCache;
    let currentDir = startDir;
    for(let level = 0; level < MAX_LEVELS; level++){
        const packageJsonPath = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["join"])(currentDir, "package.json");
        if ((0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["existsSync"])(packageJsonPath)) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$cacheMemory$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["cacheMemory"].set("packageJsonPath", startDir, {
                packageJsonPath,
                baseDir: currentDir
            });
            return {
        ...
        const parentDir = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["dirname"])(currentDir);
...
"[project]/node_modules/@intlayer/config/dist/esm/utils/normalizePath.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@intlayer/config/dist/esm/_virtual/rolldown_runtime.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@intlayer/config/dist/esm/defaultValues/build.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$_virtual$2f$rolldown_runtime$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/_virtual/rolldown_runtime.mjs [middleware] (ecmascript)");
;
//#region src/defaultValues/build.ts
var build_exports = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$_virtual$2f$rolldown_runtime$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["__export"])({
    CACHE: ()=>CACHE,
...
"[project]/node_modules/@intlayer/config/dist/esm/defaultValues/compiler.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const COMPILER_TRANSFORM_PATTERN = [
...
"[project]/node_modules/@intlayer/config/dist/esm/defaultValues/content.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var content_exports = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$_virtual$2f$rolldown_runtime$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["__export"])({
    CACHE_DIR: ()=>CACHE_DIR,
...
"[project]/node_modules/@intlayer/config/dist/esm/defaultValues/dictionary.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@intlayer/config/dist/esm/defaultValues/editor.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var editor_exports = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$_virtual$2f$rolldown_runtime$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["__export"])({
...
"[project]/node_modules/@intlayer/types/dist/esm/_virtual/rolldown_runtime.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@intlayer/types/dist/esm/locales.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$types$2f$dist$2f$esm$2f$_virtual$2f$rolldown_runtime$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/types/dist/esm/_virtual/rolldown_runtime.mjs [middleware] (ecmascript)");
;
//#region src/locales.ts
var locales_exports = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$types$2f$dist$2f$esm$2f$_virtual$2f$rolldown_runtime$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["__export"])({
    AFRIKAANS: ()=>AFRIKAANS,
...
"[project]/node_modules/@intlayer/types/dist/esm/locales.mjs [middleware] (ecmascript) <export locales_exports as Locales>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "Locales",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$types$2f$dist$2f$esm$2f$locales$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["locales_exports"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$types$2f$dist$2f$esm$2f$locales$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/types/dist/esm/locales.mjs [middleware] (ecmascript)");
}),
"[project]/node_modules/@intlayer/config/dist/esm/defaultValues/internationalization.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "STRICT_MODE",
    ()=>STRICT_MODE,
    "internationalization_exports",
    ()=>internationalization_exports
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$_virtual$2f$rolldown_runtime$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/_virtual/rolldown_runtime.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$types$2f$dist$2f$esm$2f$locales$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$export__locales_exports__as__Locales$3e$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/types/dist/esm/locales.mjs [middleware] (ecmascript) <export locales_exports as Locales>");
;
;
//#region src/defaultValues/internationalization.ts
var internationalization_exports = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$_virtual$2f$rolldown_runtime$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["__export"])({
...
const LOCALES = [
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$types$2f$dist$2f$esm$2f$locales$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$export__locales_exports__as__Locales$3e$__["Locales"].ENGLISH
];
const REQUIRED_LOCALES = [];
const DEFAULT_LOCALE = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$types$2f$dist$2f$esm$2f$locales$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$export__locales_exports__as__Locales$3e$__["Locales"].ENGLISH;
const STRICT_MODE = "inclusive";
;
 //# sourceMappingURL=internationalization.mjs.map
}),
"[project]/node_modules/@intlayer/config/dist/esm/defaultValues/log.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$_virtual$2f$rolldown_runtime$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/_virtual/rolldown_runtime.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$logger$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/logger.mjs [middleware] (ecmascript)");
;
;
//#region src/defaultValues/log.ts
var log_exports = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$_virtual$2f$rolldown_runtime$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["__export"])({
    MODE: ()=>MODE,
    PREFIX: ()=>PREFIX
});
const MODE = "default";
const PREFIX = `${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$logger$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["ANSIColors"].GREY_DARK}[intlayer] ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$logger$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["ANSIColors"].RESET}`;
;
 //# sourceMappingURL=log.mjs.map
}),
"[project]/node_modules/@intlayer/config/dist/esm/defaultValues/routing.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var routing_exports = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$_virtual$2f$rolldown_runtime$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["__export"])({
    BASE_PATH: ()=>BASE_PATH,
...
"[project]/node_modules/@intlayer/types/package.json (json)", ((__turbopack_context__) => {

__turbopack_context__.v({"name":"@intlayer/types","version":"7.4.0","private":false,"description":"Retrieve Intlayer configurations and manage environment variables for both server-side and client-side environments.","keywords":["intlayer","types","typescript"],"homepage":"https://intlayer.org","bugs":{"url":"https://github.com/aymericzip/intlayer/issues"},"repository":{"type":"git","url":"git+https://github.com/aymericzip/intlayer.git"},"license":"Apache-2.0","author":{"name":"Aymeric PINEAU","url":"https://github.com/aymericzip"},"contributors":[{"name":"Aymeric Pineau","email":"ay.pineau@gmail.com","url":"https://github.com/aymericzip"}],"sideEffects":false,"exports":{".":{"types":"./dist/types/index.d.ts","require":"./dist/cjs/index.cjs","import":"./dist/esm/index.mjs"},"./package.json":"./package.json"},"main":"dist/cjs/index.cjs","module":"dist/esm/index.mjs","types":"dist/types/index.d.ts","typesVersions":{"*":{".":["./dist/types/index.d.ts"],"client":["./dist/types/client.d.ts"],"built":["./dist/types/built.d.ts"],"package.json":["./package.json"]}},"files":["./dist","./package.json"],"scripts":{"_prepublish":"cp -f ../../../README.md ./README.md","build":"tsdown --config tsdown.config.ts","build:ci":"tsdown --config tsdown.config.ts","clean":"rimraf ./dist .turbo","dev":"tsdown --config tsdown.config.ts --watch","format":"biome format . --check","format:fix":"biome format --write .","lint":"biome lint .","lint:fix":"biome lint --write .","prepublish":"echo prepublish temporally disabled to avoid rewrite readme","publish":"bun publish || true","publish:canary":"bun publish --access public --tag canary || true","publish:latest":"bun publish --access public --tag latest || true","test":"vitest run","test:watch":"vitest","typecheck":"tsc --noEmit --project tsconfig.types.json"},"devDependencies":{"@types/node":"24.10.1","@utils/ts-config":"1.0.4","@utils/ts-config-types":"1.0.4","@utils/tsdown-config":"1.0.4","rimraf":"6.1.2","tsdown":"0.16.8","typescript":"5.9.3","vitest":"4.0.15"},"engines":{"node":">=14.18"},"bug":{"url":"https://github.com/aymericzip/intlayer/issues"}});}),
"[project]/node_modules/@intlayer/config/dist/esm/configFile/buildConfigurationFields.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$normalizePath$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/utils/normalizePath.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$build$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/defaultValues/build.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$compiler$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/defaultValues/compiler.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$content$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/defaultValues/content.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$dictionary$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/defaultValues/dictionary.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$editor$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/defaultValues/editor.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$internationalization$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/defaultValues/internationalization.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$log$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/defaultValues/log.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$routing$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/defaultValues/routing.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:path [external] (node:path, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$types$2f$package$2e$json__$28$json$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/types/package.json (json)");
;
;
;
;
...
const buildInternationalizationFields = (customConfiguration)=>({
        locales: customConfiguration?.locales ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$internationalization$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["LOCALES"],
        requiredLocales: customConfiguration?.requiredLocales ?? customConfiguration?.locales ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$internationalization$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["REQUIRED_LOCALES"],
        strictMode: customConfiguration?.strictMode ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$internationalization$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["STRICT_MODE"],
        defaultLocale: customConfiguration?.defaultLocale ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$internationalization$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["DEFAULT_LOCALE"]
    });
const buildRoutingFields = (customConfiguration)=>({
        mode: customConfiguration?.mode ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$routing$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["ROUTING_MODE"],
        storage: customConfiguration?.storage ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$routing$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["STORAGE"],
        basePath: customConfiguration?.basePath ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$routing$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["BASE_PATH"]
    });
const buildContentFields = (customConfiguration, baseDir)=>{
    const notDerivedContentConfig = {
        fileExtensions: customConfiguration?.fileExtensions ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$content$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["FILE_EXTENSIONS"],
        baseDir: customConfiguration?.baseDir ?? baseDir ?? process.cwd(),
        excludedPath: customConfiguration?.excludedPath ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$content$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["EXCLUDED_PATHS"],
        watch: customConfiguration?.watch ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$content$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["WATCH"],
        formatCommand: customConfiguration?.formatCommand
    };
    const optionalJoinBaseDir = (path)=>{
        if ((0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["isAbsolute"])(path)) return path;
        return (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["join"])(notDerivedContentConfig.baseDir, path);
    };
    const baseDirDerivedConfiguration = {
        contentDir: (customConfiguration?.contentDir ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$content$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["CONTENT_DIR"]).map(optionalJoinBaseDir),
        moduleAugmentationDir: optionalJoinBaseDir(customConfiguration?.moduleAugmentationDir ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$content$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["MODULE_AUGMENTATION_DIR"]),
        unmergedDictionariesDir: optionalJoinBaseDir(customConfiguration?.unmergedDictionariesDir ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$content$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["UNMERGED_DICTIONARIES_DIR"]),
        remoteDictionariesDir: optionalJoinBaseDir(customConfiguration?.remoteDictionariesDir ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$content$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["REMOTE_DICTIONARIES_DIR"]),
        dictionariesDir: optionalJoinBaseDir(customConfiguration?.dictionariesDir ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$content$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["DICTIONARIES_DIR"]),
        dynamicDictionariesDir: optionalJoinBaseDir(customConfiguration?.dynamicDictionariesDir ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$content$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["DYNAMIC_DICTIONARIES_DIR"]),
        fetchDictionariesDir: optionalJoinBaseDir(customConfiguration?.fetchDictionariesDir ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$content$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["FETCH_DICTIONARIES_DIR"]),
        typesDir: optionalJoinBaseDir(customConfiguration?.typesDir ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$content$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["TYPES_DIR"]),
        mainDir: optionalJoinBaseDir(customConfiguration?.mainDir ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$content$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["MAIN_DIR"]),
        configDir: optionalJoinBaseDir(customConfiguration?.configDir ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$content$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["CONFIG_DIR"]),
        cacheDir: optionalJoinBaseDir(customConfiguration?.cacheDir ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$content$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["CACHE_DIR"])
    };
    const patternsConfiguration = {
        watchedFilesPattern: notDerivedContentConfig.fileExtensions.map((ext)=>`/**/*${ext}`),
        watchedFilesPatternWithPath: notDerivedContentConfig.fileExtensions.flatMap((ext)=>baseDirDerivedConfiguration.contentDir.map((contentDir)=>`${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$normalizePath$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["normalizePath"])(contentDir)}/**/*${ext}`)),
        outputFilesPatternWithPath: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$normalizePath$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["normalizePath"])(baseDirDerivedConfiguration.dictionariesDir)}/**/*.json`
    };
    return {
...
const buildEditorFields = (customConfiguration)=>({
        applicationURL: customConfiguration?.applicationURL ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$editor$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["APPLICATION_URL"],
        editorURL: customConfiguration?.editorURL ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$editor$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["EDITOR_URL"],
        cmsURL: customConfiguration?.cmsURL ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$editor$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["CMS_URL"],
        backendURL: customConfiguration?.backendURL ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$editor$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["BACKEND_URL"],
        port: customConfiguration?.port ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$editor$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["PORT"],
        enabled: customConfiguration?.enabled ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$editor$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["IS_ENABLED"],
        clientId: customConfiguration?.clientId ?? void 0,
        clientSecret: customConfiguration?.clientSecret ?? void 0,
        dictionaryPriorityStrategy: customConfiguration?.dictionaryPriorityStrategy ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$editor$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["DICTIONARY_PRIORITY_STRATEGY"],
        liveSync: customConfiguration?.liveSync ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$editor$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["LIVE_SYNC"],
        liveSyncPort: customConfiguration?.liveSyncPort ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$editor$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["LIVE_SYNC_PORT"],
        liveSyncURL: customConfiguration?.liveSyncURL ?? `http://localhost:${customConfiguration?.liveSyncPort ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$editor$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["LIVE_SYNC_PORT"]}`
    });
const buildLogFields = (customConfiguration, logFunctions)=>({
        mode: customConfiguration?.mode ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$log$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["MODE"],
        prefix: customConfiguration?.prefix ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$log$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["PREFIX"],
...
const buildBuildFields = (customConfiguration)=>({
        ...
        importMode: customConfiguration?.importMode ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$build$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["IMPORT_MODE"],
        traversePattern: customConfiguration?.traversePattern ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$build$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["TRAVERSE_PATTERN"],
        outputFormat: customConfiguration?.outputFormat ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$build$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["OUTPUT_FORMAT"],
        cache: customConfiguration?.cache ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$build$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["CACHE"],
        require: customConfiguration?.require
    });
const buildCompilerFields = (customConfiguration)=>({
        enabled: customConfiguration?.enabled ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$compiler$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["COMPILER_ENABLED"],
        transformPattern: customConfiguration?.transformPattern ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$compiler$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["COMPILER_TRANSFORM_PATTERN"],
        excludePattern: customConfiguration?.excludePattern ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$compiler$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["COMPILER_EXCLUDE_PATTERN"],
        outputDir: customConfiguration?.outputDir ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$compiler$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["COMPILER_OUTPUT_DIR"]
    });
const buildDictionaryFields = (customConfiguration)=>({
        fill: customConfiguration?.fill ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$dictionary$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["FILL"],
...
*/ const buildConfigurationFields = (customConfiguration, baseDir, logFunctions)=>{
    storedConfiguration = {
        ...
        metadata: {
            name: "Intlayer",
            version: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$types$2f$package$2e$json__$28$json$29$__["default"].version,
...
"[project]/node_modules/@intlayer/config/dist/esm/configFile/searchConfigurationFile.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$logger$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/logger.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$getPackageJsonPath$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/utils/getPackageJsonPath.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:path [external] (node:path, cjs)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:fs [external] (node:fs, cjs)");
;
;
...
const configurationFiles = [
    ...EXTENSION.filter((extension)=>extension !== "").map((ext)=>`${CONFIGURATION_FILE_NAME_1}.${ext}`),
    CONFIGURATION_FILE_NAME_2
];
/**
...
*/ const searchConfigurationFile = (startDir)=>{
    ...
    const { baseDir } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$getPackageJsonPath$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["getPackageJsonPath"])(startDir);
    for (const fileName of configurationFiles)try {
        const filePath = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["resolve"])(baseDir, fileName);
        if (!(0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["existsSync"])(filePath)) {} else {
            numCustomConfiguration += 1;
            if (!configurationFilePath) configurationFilePath = filePath;
        }
    } catch (error) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$logger$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["logger"])(`${fileName}: ${error}`, {
            level: "error"
        });
    }
    return {
...
"[project]/node_modules/@intlayer/config/dist/esm/utils/ESMxCJSHelpers.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__import$2e$meta__ = {
    get url () {
        return `file://${__turbopack_context__.P("node_modules/@intlayer/config/dist/esm/utils/ESMxCJSHelpers.mjs")}`;
    }
};
;
;
...
*/ const getProjectRequire = (startDir)=>{
    const { packageJsonPath } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$getPackageJsonPath$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["getPackageJsonPath"])(startDir);
    return (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$module__$5b$external$5d$__$28$node$3a$module$2c$__cjs$29$__["createRequire"])(packageJsonPath);
};
/**
...
*/ const configESMxCJSRequire = isESModule ? (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$module__$5b$external$5d$__$28$node$3a$module$2c$__cjs$29$__["createRequire"])(__TURBOPACK__import$2e$meta__.url) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$_virtual$2f$rolldown_runtime$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["__require"];
;
...
"[project]/node_modules/@intlayer/config/dist/esm/loadEnvFile.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getEnvFilePath = (env = "development", envFile)=>{
    return (envFile ? [
        ...
        ".env.local",
        ".env"
    ]).find(__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["existsSync"]);
};
...
"[project]/node_modules/@intlayer/config/dist/esm/loadExternalFile/parseFileContent.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$ESMxCJSHelpers$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/utils/ESMxCJSHelpers.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$loadEnvFile$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/loadEnvFile.mjs [middleware] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$esbuild__$5b$external$5d$__$28$esbuild$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/esbuild [external] (esbuild, cjs)");
;
;
;
;
...
const getSandBoxContext = (options)=>{
    ...
    const baseRequire = typeof projectRequire === "function" ? projectRequire : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$ESMxCJSHelpers$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["getProjectRequire"])();
    const mockedRequire = (()=>{
        const mockTable = Object.assign({
            esbuild: __TURBOPACK__imported__module__$5b$externals$5d2f$esbuild__$5b$external$5d$__$28$esbuild$2c$__cjs$29$__
        }, mocks);
    ...
    const sandboxContext = {
        ...
        process: {
            ...
            env: {
                ...process.env,
                ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$loadEnvFile$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["loadEnvFile"])(envVarOptions),
                ...additionalEnvVars
            }
        },
        console,
...
const parseFileContent = (fileContentString, options)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$vm__$5b$external$5d$__$28$node$3a$vm$2c$__cjs$29$__["runInNewContext"])(`"use strict";\n${fileContentString}`, sandboxContext);
    const candidates = [
...
"[project]/node_modules/@intlayer/config/dist/esm/loadExternalFile/bundleFile.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getTransformationOptions = (filePath)=>({
        ...
        bundle: true,
        define: {
            "import.meta.url": JSON.stringify((0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$url__$5b$external$5d$__$28$node$3a$url$2c$__cjs$29$__["pathToFileURL"])(filePath).href)
        }
    });
const bundleFileSync = (code, filePath, options)=>{
    return (0, __TURBOPACK__imported__module__$5b$externals$5d2f$esbuild__$5b$external$5d$__$28$esbuild$2c$__cjs$29$__["buildSync"])({
        stdin: {
            contents: code,
            loader: getLoader((0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["extname"])(filePath)),
            resolveDir: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["dirname"])(filePath),
            sourcefile: filePath
        },
...
const bundleFile = async (code, filePath, options)=>{
    return (await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$esbuild__$5b$external$5d$__$28$esbuild$2c$__cjs$29$__["build"])({
        stdin: {
            contents: code,
            loader: getLoader((0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["extname"])(filePath)),
            resolveDir: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["dirname"])(filePath),
...
"[project]/node_modules/@intlayer/config/dist/esm/loadExternalFile/transpileTSToMJS.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "transpileTSToMJS",
    ()=>transpileTSToMJS,
    "transpileTSToMJSSync",
    ()=>transpileTSToMJSSync
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$getPackageJsonPath$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/utils/getPackageJsonPath.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$loadExternalFile$2f$bundleFile$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/loadExternalFile/bundleFile.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:path [external] (node:path, cjs)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$esbuild__$5b$external$5d$__$28$esbuild$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/esbuild [external] (esbuild, cjs)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$url__$5b$external$5d$__$28$node$3a$url$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:url [external] (node:url, cjs)");
;
...
const getTransformationOptions = (filePath)=>({
        ...
        packages: "external",
        bundle: true,
        tsconfig: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["join"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$getPackageJsonPath$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["getPackageJsonPath"])((0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["dirname"])(filePath)).baseDir, "tsconfig.json"),
        define: {
            "import.meta.url": JSON.stringify((0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$url__$5b$external$5d$__$28$node$3a$url$2c$__cjs$29$__["pathToFileURL"])(filePath).href)
        }
    });
const transpileTSToMJSSync = (code, filePath, options)=>{
    return (0, __TURBOPACK__imported__module__$5b$externals$5d2f$esbuild__$5b$external$5d$__$28$esbuild$2c$__cjs$29$__["buildSync"])({
        stdin: {
            contents: code,
            loader: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$loadExternalFile$2f$bundleFile$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["getLoader"])((0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["extname"])(filePath)),
            resolveDir: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["dirname"])(filePath),
            sourcefile: filePath
        },
        ...getTransformationOptions(filePath),
...
"[project]/node_modules/@intlayer/config/dist/esm/loadExternalFile/loadExternalFile.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$logger$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/logger.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$ESMxCJSHelpers$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/utils/ESMxCJSHelpers.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$loadExternalFile$2f$parseFileContent$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/loadExternalFile/parseFileContent.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$loadExternalFile$2f$transpileTSToMJS$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/loadExternalFile/transpileTSToMJS.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:path [external] (node:path, cjs)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:fs [external] (node:fs, cjs)");
...
*/ const loadExternalFileSync = (filePath, options)=>{
    const fileExtension = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["extname"])(filePath);
    const safeProjectRequire = options?.projectRequire ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$ESMxCJSHelpers$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["getProjectRequire"])();
    try {
        if (fileExtension === "json") {
            delete safeProjectRequire.cache[safeProjectRequire.resolve(filePath)];
            return safeProjectRequire(filePath);
        }
        const moduleResultString = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$loadExternalFile$2f$transpileTSToMJS$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["transpileTSToMJSSync"])((0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["readFileSync"])(filePath, "utf-8"), filePath);
        if (!moduleResultString) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$logger$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["logger"])("File could not be loaded.", {
                level: "error"
            });
            return;
        }
        const fileContent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$loadExternalFile$2f$parseFileContent$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["parseFileContent"])(moduleResultString, {
        ...
        if (typeof fileContent === "undefined") {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$logger$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["logger"])(`File file could not be loaded. Path : ${filePath}`);
            return;
        }
        return fileContent;
    } catch (error) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$logger$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["logger"])([
            `Error: ${error.message} - `,
...
*/ const loadExternalFile = async (filePath, options)=>{
    ...
    try {
        ...
        const moduleResultString = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$loadExternalFile$2f$transpileTSToMJS$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["transpileTSToMJS"])(await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs$2f$promises__$5b$external$5d$__$28$node$3a$fs$2f$promises$2c$__cjs$29$__["readFile"])(filePath, "utf-8"), filePath, options?.buildOptions);
        if (!moduleResultString) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$logger$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["logger"])("File could not be loaded.", {
                level: "error"
            });
        ...
        if (typeof fileContent === "undefined") {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$logger$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["logger"])(`File file could not be loaded. Path : ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$logger$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["colorizePath"])(filePath)}`);
            return;
        }
        return fileContent;
    } catch (error) {
...
"[project]/node_modules/@intlayer/config/dist/esm/configFile/loadConfigurationFile.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$ESMxCJSHelpers$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/utils/ESMxCJSHelpers.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$loadExternalFile$2f$loadExternalFile$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/loadExternalFile/loadExternalFile.mjs [middleware] (ecmascript)");
;
;
...
const getAliases = (options)=>{
    try {
        return {
            ...options?.aliases,
            intlayer: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$ESMxCJSHelpers$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["configESMxCJSRequire"].resolve("@intlayer/types")
        };
    } catch  {
...
*/ const loadConfigurationFile = (configFilePath, options)=>{
    return filterValidConfiguration((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$loadExternalFile$2f$loadExternalFile$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["loadExternalFileSync"])(configFilePath, {
        ...options,
...
"[project]/node_modules/@intlayer/config/dist/esm/configFile/getConfiguration.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$cacheMemory$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/utils/cacheMemory.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$getPackageJsonPath$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/utils/getPackageJsonPath.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$configFile$2f$buildConfigurationFields$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/configFile/buildConfigurationFields.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$configFile$2f$searchConfigurationFile$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/configFile/searchConfigurationFile.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$configFile$2f$loadConfigurationFile$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/configFile/loadConfigurationFile.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:path [external] (node:path, cjs)");
...
*/ const getConfigurationAndFilePath = (options)=>{
    let baseDir;
    try {
        baseDir = options?.baseDir ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$getPackageJsonPath$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["getPackageJsonPath"])().baseDir;
    } catch (_err) {
        return {
            configuration: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$configFile$2f$buildConfigurationFields$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["buildConfigurationFields"])({}, options?.baseDir, options?.logFunctions),
            configurationFilePath: void 0
        };
    }
    const cachedConfiguration = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$cacheMemory$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["cacheMemory"].get(options);
    if (cachedConfiguration) return cachedConfiguration;
    const { configurationFilePath, numCustomConfiguration } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$configFile$2f$searchConfigurationFile$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["searchConfigurationFile"])(baseDir);
    if (options?.override?.log?.mode === "verbose") logConfigFileResult(baseDir, numCustomConfiguration, configurationFilePath);
    let storedConfiguration;
    if (configurationFilePath) storedConfiguration = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$configFile$2f$buildConfigurationFields$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["buildConfigurationFields"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$configFile$2f$loadConfigurationFile$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["loadConfigurationFile"])(configurationFilePath, {
    ...
    else storedConfiguration = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$configFile$2f$buildConfigurationFields$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["buildConfigurationFields"])({}, options?.baseDir, options?.logFunctions);
    const configWithProjectRequire = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$defu$2f$dist$2f$defu$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["defu"])(options?.require ? {
        build: {
            require: options?.require,
            cache: options?.cache
        }
    } : {}, storedConfiguration);
    const configuration = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$defu$2f$dist$2f$defu$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["defu"])(options?.override ?? {}, configWithProjectRequire);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$utils$2f$cacheMemory$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["cacheMemory"].set(options, {
        configuration,
        configurationFilePath
    });
    return {
...
const logConfigFileResult = (baseDir, numCustomConfiguration, configurationFilePath)=>{
    if (numCustomConfiguration === 0) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$logger$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["logger"])("Configuration file not found, using default configuration.", {
        isVerbose: true
    });
    else {
        const relativeOutputPath = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["relative"])(baseDir, configurationFilePath);
        if (numCustomConfiguration === 1) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$logger$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["logger"])(`Configuration file found: ${relativeOutputPath}.`, {
            isVerbose: true
        });
        else (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$logger$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["logger"])(`Multiple configuration files found, using ${relativeOutputPath}.`, {
            isVerbose: true
        });
    }
};
...
"[project]/node_modules/@intlayer/config/dist/esm/built.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$configFile$2f$getConfiguration$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/configFile/getConfiguration.mjs [middleware] (ecmascript)");
;
//#region src/built.ts
const configuration = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$configFile$2f$getConfiguration$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["getConfiguration"])();
var built_default = configuration;
;
 //# sourceMappingURL=built.mjs.map
}),
"[project]/node_modules/@intlayer/core/dist/esm/localization/localeResolver.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$built$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/built.mjs [middleware] (ecmascript)");
;
...
*/ const localeResolver = (selectedLocale, locales = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$built$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["default"]?.internationalization?.locales, defaultLocale = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$built$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["default"]?.internationalization?.defaultLocale)=>{
...
"[project]/node_modules/@intlayer/core/dist/esm/localization/localeDetector.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$core$2f$dist$2f$esm$2f$localization$2f$localeResolver$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/core/dist/esm/localization/localeResolver.mjs [middleware] (ecmascript)");
;
...
*/ const localeDetector = (headers, availableLocales, defaultLocale)=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$core$2f$dist$2f$esm$2f$localization$2f$localeResolver$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["localeResolver"])(getPreferredLanguages(acceptLanguageHeader, availableLocales), availableLocales, defaultLocale);
};
;
 //# sourceMappingURL=localeDetector.mjs.map
}),
"[project]/node_modules/next-intlayer/dist/esm/proxy/localeDetector.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$core$2f$dist$2f$esm$2f$localization$2f$localeDetector$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/core/dist/esm/localization/localeDetector.mjs [middleware] (ecmascript)");
;
...
*/ const localeDetector = (request)=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$core$2f$dist$2f$esm$2f$localization$2f$localeDetector$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["localeDetector"])(negotiatorHeaders);
};
;
 //# sourceMappingURL=localeDetector.mjs.map
}),
"[project]/node_modules/@intlayer/config/dist/esm/defaultValues/index.mjs [middleware] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "defaultValues_exports",
    ()=>defaultValues_exports
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$_virtual$2f$rolldown_runtime$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/_virtual/rolldown_runtime.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$build$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/defaultValues/build.mjs [middleware] (ecmascript)");
...
var defaultValues_exports = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$_virtual$2f$rolldown_runtime$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["__export"])({
    Build: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$build$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["build_exports"],
    Content: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$content$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["content_exports"],
    Editor: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$editor$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["editor_exports"],
    Internationalization: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$internationalization$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["internationalization_exports"],
    Log: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$log$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["log_exports"],
    Routing: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$routing$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["routing_exports"]
});
;
 //# sourceMappingURL=index.mjs.map
}),
"[project]/node_modules/@intlayer/config/dist/esm/defaultValues/index.mjs [middleware] (ecmascript) <locals> <export defaultValues_exports as DefaultValues>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "DefaultValues",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$index$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["defaultValues_exports"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$index$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/defaultValues/index.mjs [middleware] (ecmascript) <locals>");
}),
"[project]/node_modules/@intlayer/core/dist/esm/getStorageAttributes.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$index$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__$3c$export__defaultValues_exports__as__DefaultValues$3e$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/defaultValues/index.mjs [middleware] (ecmascript) <locals> <export defaultValues_exports as DefaultValues>");
;
...
*/ const createCookieEntry = (options)=>{
    ...
    return {
        name: name ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$index$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__$3c$export__defaultValues_exports__as__DefaultValues$3e$__["DefaultValues"].Routing.COOKIE_NAME,
        attributes: {
            path,
            expires,
            domain,
...
*/ const createWebStorageEntry = (options)=>{
    const { name } = options ?? {};
    return {
        name: name ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$index$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__$3c$export__defaultValues_exports__as__DefaultValues$3e$__["DefaultValues"].Routing.LOCALE_STORAGE_NAME
    };
};
/**
...
*/ const createHeaderEntry = (options)=>{
    const { name } = options ?? {};
    return {
        name: name ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$index$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__$3c$export__defaultValues_exports__as__DefaultValues$3e$__["DefaultValues"].Routing.HEADER_NAME
    };
};
/**
...
*/ const processStorageEntry = (entry)=>{
    if (typeof entry === "string") {
        ...
        if (entry === "localStorage") return {
            localStorage: [
                createWebStorageEntry()
            ]
        };
        if (entry === "sessionStorage") return {
            sessionStorage: [
                createWebStorageEntry()
            ]
        };
    ...
    if (typeof entry === "object" && entry !== null) {
        ...
        if (isCookieEntry(typedEntry)) return {
            cookies: [
                createCookieEntry(typedEntry)
            ]
        };
...
"[project]/node_modules/@intlayer/core/dist/esm/utils/getCookie.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@intlayer/core/dist/esm/utils/localeStorage.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$core$2f$dist$2f$esm$2f$getStorageAttributes$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/core/dist/esm/getStorageAttributes.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$core$2f$dist$2f$esm$2f$utils$2f$getCookie$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/core/dist/esm/utils/getCookie.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$built$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/built.mjs [middleware] (ecmascript)");
;
;
;
...
*/ const getLocaleFromStorage = (options)=>{
    const { routing, internationalization } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$built$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["default"];
    const { locales } = internationalization;
    const { storage } = routing;
    if (storage === false || options?.isCookieEnabled === false) return void 0;
    const storageAttributes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$core$2f$dist$2f$esm$2f$getStorageAttributes$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["getStorageAttributes"])(storage);
    ...
    const readCookie = (name)=>{
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$core$2f$dist$2f$esm$2f$utils$2f$getCookie$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["getCookie"])(name);
    };
...
*/ const setLocaleInStorage = (locale, options)=>{
    if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$built$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["default"].routing.storage === false || options?.isCookieEnabled === false) return;
    const storageAttributes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$core$2f$dist$2f$esm$2f$getStorageAttributes$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["getStorageAttributes"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$built$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["default"].routing.storage);
    for(let i = 0; i < storageAttributes.cookies.length; i++){
...
"[project]/node_modules/next-intlayer/dist/esm/proxy/intlayerProxy.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$intlayer$2f$dist$2f$esm$2f$proxy$2f$localeDetector$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next-intlayer/dist/esm/proxy/localeDetector.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$built$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/built.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$core$2f$dist$2f$esm$2f$utils$2f$localeStorage$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/core/dist/esm/utils/localeStorage.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$index$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__$3c$export__defaultValues_exports__as__DefaultValues$3e$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/defaultValues/index.mjs [middleware] (ecmascript) <locals> <export defaultValues_exports as DefaultValues>");
...
const { internationalization, routing } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$built$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["default"] ?? {};
const { locales, defaultLocale } = internationalization ?? {};
const { basePath, mode } = routing ?? {};
const effectiveMode = mode ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$defaultValues$2f$index$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__$3c$export__defaultValues_exports__as__DefaultValues$3e$__["DefaultValues"].Routing.ROUTING_MODE;
...
*/ const getLocalLocale = (request)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$core$2f$dist$2f$esm$2f$utils$2f$localeStorage$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["getLocaleFromStorage"])({
...
*/ const handleMissingPathLocale = (request, localLocale, pathname)=>{
    let locale = localLocale ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$intlayer$2f$dist$2f$esm$2f$proxy$2f$localeDetector$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["localeDetector"]?.(request) ?? defaultLocale;
...
*/ const rewriteUrl = (request, newPath, locale)=>{
    ...
    const response = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].rewrite(new URL(pathWithSearch, request.url));
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$core$2f$dist$2f$esm$2f$utils$2f$localeStorage$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["setLocaleInStorage"])(locale, {
...
*/ const redirectUrl = (request, newPath)=>{
    const search = request.nextUrl.search;
    const pathWithSearch = search && !newPath.includes("?") ? `${newPath}${search}` : newPath;
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL(pathWithSearch, request.url));
};
;
 //# sourceMappingURL=intlayerProxy.mjs.map
}),
"[project]/node_modules/next-intlayer/dist/esm/proxy/multipleProxies.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
*/ const multipleProxies = (proxies)=>async (req, event, response)=>{
        ...
        if (redirect) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL(redirect, req.url), {
            status: 307
        });
        const rewrite = mergedHeaders.get("x-middleware-rewrite");
        if (rewrite) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].rewrite(new URL(rewrite, req.url), {
            request: {
...
"[project]/node_modules/@intlayer/core/dist/esm/utils/checkIsURLAbsolute.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@intlayer/core/dist/esm/localization/getLocaleFromPath.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$core$2f$dist$2f$esm$2f$utils$2f$checkIsURLAbsolute$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/core/dist/esm/utils/checkIsURLAbsolute.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$types$2f$dist$2f$esm$2f$locales$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$export__locales_exports__as__Locales$3e$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/types/dist/esm/locales.mjs [middleware] (ecmascript) <export locales_exports as Locales>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$built$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@intlayer/config/dist/esm/built.mjs [middleware] (ecmascript)");
;
;
...
*/ const getLocaleFromPath = (inputUrl)=>{
    const { defaultLocale, locales } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$built$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["default"]?.internationalization ?? {};
    if (!defaultLocale || !locales) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$types$2f$dist$2f$esm$2f$locales$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$export__locales_exports__as__Locales$3e$__["Locales"].ENGLISH;
    const isAbsoluteUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$core$2f$dist$2f$esm$2f$utils$2f$checkIsURLAbsolute$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["checkIsURLAbsolute"])(inputUrl);
...
"[project]/node_modules/@intlayer/core/dist/esm/localization/getPathWithoutLocale.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
*/ const getPathWithoutLocale = (inputUrl, locales = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$config$2f$dist$2f$esm$2f$built$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["default"]?.internationalization?.locales)=>{
    const isAbsoluteUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$intlayer$2f$core$2f$dist$2f$esm$2f$utils$2f$checkIsURLAbsolute$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["checkIsURLAbsolute"])(inputUrl);
    let fixedInputUrl = inputUrl;
    if (inputUrl.endsWith("/")) fixedInputUrl = inputUrl.slice(0, -1);
...
//# sourceMappingURL=node_modules_3046a33c._.js.map