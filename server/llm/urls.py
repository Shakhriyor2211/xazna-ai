...
user_patterns = [
    ...
    path("session/<uuid:session_id>", UserLLMSessionItemAPIView.as_view(), name="user_session_item"),
...
token_patterns = [
    ...
    path("session/<uuid:session_id>", TokenLLMSessionItemAPIView.as_view(), name="token_session_item"),
