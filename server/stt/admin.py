...
from stt.models import UserSTTModel, STTModelModel, TokenSTTModel


@admin.register(UserSTTModel)
class UserSTTAdmin(admin.ModelAdmin):
...
@admin.register(TokenSTTModel)
class TokenSTTAdmin(admin.ModelAdmin):
